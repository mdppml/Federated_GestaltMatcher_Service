...
def wait_until_file_ready(file_path, wait_time=1):
    """
    Wait until the file exists and its size remains constant for a certain period.
    """
    ...
    # Wait until the file size remains constant
    # wait_count = 0
    while True:
