...
def get_train_and_val_datasets(
    ...
    if dataset == 'gmdb':
        dataset_train = GestaltMatcherDataset(
            ...
            target_file_path=os.path.join(base_dir, "GestaltMatcherDB", version, "gmdb_metadata", federated_folder,
                                         f"{metadata_file_suffix}gmdb_train_images_{version}{federated_suffix}.csv"),
        ...
        dataset_val = GestaltMatcherDataset(
            ...
            imgs_dir=os.path.join(base_dir, "GestaltMatcherDB", version, "gmdb_align"),
            target_file_path=os.path.join(base_dir, "GestaltMatcherDB", version, "gmdb_metadata", federated_folder,
                                         f"{metadata_file_suffix}gmdb_val_images_{version}{federated_suffix}.csv"),
